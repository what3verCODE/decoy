...
/** Write a transport-neutral {@link ResponsePlan} (already serialized by `@decoy/core`) to the Nest response. */
function writePlan(res: NestResponse, plan: ResponsePlan): void {
